...
void bindPyFixedFunctionTransform(py::module & m)
{
    ...
    py::class_<FixedFunctionTransform, 
        ...
        .def("getFormatMetadata", 
             ...
             &FixedFunctionTransform::getFormatMetadata,
             DS(FixedFunctionTransform, getFormatMetadata, 2),
             py::return_value_policy::reference_internal)
        .def("equals", &FixedFunctionTransform::equals,
             DS(FixedFunctionTransform, equals),
             "other"_a)
        .def("getStyle", &FixedFunctionTransform::getStyle,
             DS(FixedFunctionTransform, getStyle))
        .def("setStyle", &FixedFunctionTransform::setStyle,
             DS(FixedFunctionTransform, setStyle),
             "style"_a)
