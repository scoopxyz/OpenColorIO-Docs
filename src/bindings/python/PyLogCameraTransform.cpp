...
void bindPyLogCameraTransform(py::module & m)
{
    ...
    py::class_<LogCameraTransform, 
        ...
        .def("getFormatMetadata", 
             ...
             DS(LogCameraTransform, getFormatMetadata, 2),
             py::return_value_policy::reference_internal)
        .def("equals", &LogCameraTransform::equals,
             DS(LogCameraTransform, equals),
             "other"_a)
        .def("getBase", &LogCameraTransform::getBase,
             DS(LogCameraTransform, getBase))
        .def("setBase", &LogCameraTransform::setBase,
             DS(LogCameraTransform, setBase),
             "base"_a)
        .def("getLogSideSlopeValue", [](LogCameraTransformRcPtr self)
            {
             ...
             DS(LogCameraTransform, getLogSideSlopeValue))
        ...
        .def("unsetLinearSlopeValue", &LogCameraTransform::unsetLinearSlopeValue,
             DS(LogCameraTransform, unsetLinearSlopeValue));
}
