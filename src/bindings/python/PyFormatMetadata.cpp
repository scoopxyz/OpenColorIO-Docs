...
void bindPyFormatMetadata(py::module & m)
{
    auto cls = py::class_<FormatMetadata>(m, "FormatMetadata", DS(FormatMetadata))
        ...
        .def("__len__", &FormatMetadata::getNumAttributes, DS(FormatMetadata, getNumAttributes))
        .def("__getitem__", [](const FormatMetadata & self, const std::string & name) 
            {
             ...
             "name"_a)
        .def("__setitem__", &FormatMetadata::addAttribute,
             DS(FormatMetadata, addAttribute),
             "name"_a,
             "value"_a)
        ...
        .def("setName", &FormatMetadata::setName,
             DS(FormatMetadata, setName),
             "name"_a)
        .def("getValue", &FormatMetadata::getValue, DS(FormatMetadata, getValue))
        .def("setValue", &FormatMetadata::setValue,
             DS(FormatMetadata, setValue),
             "value"_a)
