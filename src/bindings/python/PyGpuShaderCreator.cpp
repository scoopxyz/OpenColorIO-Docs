...
void bindPyGpuShaderCreator(py::module & m)
{
    auto cls = py::class_<GpuShaderCreator, 
        ...
        .def("getUniqueID", &GpuShaderCreator::getUniqueID,
             DS(GpuShaderCreator, getUniqueID))
        .def("setUniqueID", &GpuShaderCreator::setUniqueID,
             DS(GpuShaderCreator, setUniqueID),
             "uid"_a)
        .def("getLanguage", &GpuShaderCreator::getUniqueID,
             DS(GpuShaderCreator, getLanguage))
        .def("setLanguage", &GpuShaderCreator::setUniqueID,
             DS(GpuShaderCreator, setLanguage),
             "lang"_a)
        .def("getFunctionName", &GpuShaderCreator::getFunctionName,
             DS(GpuShaderCreator, getFunctionName))
        .def("setFunctionName", &GpuShaderCreator::setFunctionName,
             DS(GpuShaderCreator, setFunctionName),
             "name"_a)
        .def("getPixelName", &GpuShaderCreator::getPixelName,
             DS(GpuShaderCreator, getPixelName))
        .def("setPixelName", &GpuShaderCreator::setPixelName,
             DS(GpuShaderCreator, setPixelName),
             "name"_a)
        ...
        .def("getCacheID", &GpuShaderCreator::getCacheID,
             DS(GpuShaderCreator, getCacheID))
        .def("begin", &GpuShaderCreator::begin,
             DS(GpuShaderCreator, begin),
             "uid"_a)
        .def("end", &GpuShaderCreator::end,
             DS(GpuShaderCreator, end))
        .def("getTextureMaxWidth", &GpuShaderCreator::getTextureMaxWidth,
             DS(GpuShaderCreator, getTextureMaxWidth))
        ...
        .def("addUniform", &GpuShaderCreator::addUniform,
             DS(GpuShaderCreator, addUniform),
             "name"_a,
             "value"_a)
