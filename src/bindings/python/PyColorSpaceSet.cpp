...
void bindPyColorSpaceSet(py::module & m)
{
    ...
    auto cls = py::class_<ColorSpaceSet, ColorSpaceSetRcPtr /* holder */>(m, "ColorSpaceSet", DS(ColorSpaceSet))
        .def(py::init(&ColorSpaceSet::Create), DS(ColorSpaceSet, ColorSpaceSet))

        .def("__eq__", &ColorSpaceSet::operator==, py::is_operator(), DS(ColorSpaceSet, operator, eq))
        .def("__ne__", &ColorSpaceSet::operator!=, py::is_operator(), DS(ColorSpaceSet, operator, ne))
        ...
        .def("addColorSpace", &ColorSpaceSet::addColorSpace, DS(ColorSpaceSet, addColorSpace), "cs"_a)
        .def("addColorSpaces", &ColorSpaceSet::addColorSpaces, DS(ColorSpaceSet, addColorSpaces), "cs"_a)
        .def("removeColorSpace", &ColorSpaceSet::removeColorSpace, DS(ColorSpaceSet, removeColorSpace), "cs"_a)
        .def("removeColorSpaces", &ColorSpaceSet::removeColorSpaces, DS(ColorSpaceSet, removeColorSpaces), "cs"_a)
