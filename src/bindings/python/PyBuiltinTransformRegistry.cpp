...
void bindPyBuiltinTransformRegistry(py::module & m)
{
    ...
    py::class_<Wrapper>(m, "BuiltinTransformRegistry", DS(BuiltinTransformRegistry))
        .def(py::init<>(), DS(BuiltinTransformRegistry, BuiltinTransformRegistry))

        .def("getNumBuiltins",        &Wrapper::getNumBuiltins, DS(BuiltinTransformRegistry, getNumBuiltins))
        .def("getBuiltinStyle",       &Wrapper::getBuiltinStyle, DS(BuiltinTransformRegistry, getBuiltinStyle))
        .def("getBuiltinDescription", &Wrapper::getBuiltinDescription, DS(BuiltinTransformRegistry, getBuiltinDescription));
}
