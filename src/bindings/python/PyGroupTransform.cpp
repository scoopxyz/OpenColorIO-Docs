...
void bindPyGroupTransform(py::module & m)
{
    ...
    auto cls = py::class_<GroupTransform, 
        ...
        .def("__len__", &GroupTransform::getNumTransforms, DS(GroupTransform, getNumTransforms))
        .def("__getitem__", 
             (ConstTransformRcPtr (GroupTransform::*)(int) const) &GroupTransform::getTransform,
             DS(GroupTransform, getTransform),
             "index"_a)
        .def("__getitem__", 
        ...
        .def("getFormatMetadata", 
             ...
             DS(GroupTransform, getFormatMetadata, 2),
             py::return_value_policy::reference_internal)
        .def("appendTransform", &GroupTransform::appendTransform,
             DS(GroupTransform, appendTransform),
             "transform"_a)
        .def("prependTransform", &GroupTransform::prependTransform,
             DS(GroupTransform, prependTransform),
             "transform"_a);
