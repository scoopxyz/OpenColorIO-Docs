...
void bindPyContext(py::module & m)
{
    ...
    auto cls = py::class_<Context, ContextRcPtr /* holder */>(m, "Context", DS(Context))
        ...
        .def("__len__", &Context::getNumStringVars, DS(Context, getNumStringVars))
        .def("__getitem__", [](ContextRcPtr & self, const std::string & name) -> bool
            { 
             ...
             "name"_a)
        .def("__setitem__", &Context::setStringVar, DS(Context, setStringVar), "name"_a, "value"_a)
        ...
        .def("resolveStringVar", &Context::resolveStringVar, DS(Context, resolveStringVar), "val"_a)
