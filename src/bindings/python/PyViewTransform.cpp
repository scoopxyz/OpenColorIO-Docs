...
void bindPyViewTransform(py::module & m)
{
    ...
    auto cls = py::class_<ViewTransform, ViewTransformRcPtr /* holder */>(m, "ViewTransform", DS(ViewTransform))
        ...
        .def("getTransform", &ViewTransform::getTransform, DS(ViewTransform, getTransform), "dir"_a)
        .def("setTransform", &ViewTransform::setTransform, DS(ViewTransform, setTransform), "transform"_a, "dir"_a);
