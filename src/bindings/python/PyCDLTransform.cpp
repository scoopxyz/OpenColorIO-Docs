...
void bindPyCDLTransform(py::module & m)
{
    ...
    py::class_<CDLTransform, 
        ...
        .def(py::init(&CDLTransform::Create), DS(CDLTransform, CDLTransform))
        ...
        .def_static("CreateFromFile",
                    &CDLTransform::CreateFromFile,
                    DS(CDLTransform, CreateFromFile),
                    "src"_a,
                    "cccid"_a)
        ...
        .def("getFormatMetadata", 
             ...
             DS(CDLTransform, getFormatMetadata, 2),
             py::return_value_policy::reference_internal)
        ...
        .def("setDescription", &CDLTransform::setDescription, DS(CDLTransform, setDescription), "desc"_a);
}
