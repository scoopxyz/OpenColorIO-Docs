...
void bindPyLogAffineTransform(py::module & m)
{
    ...
    py::class_<LogAffineTransform, 
        ...
        .def("getFormatMetadata", 
             ...
             DS(LogAffineTransform, getFormatMetadata, 2),
             py::return_value_policy::reference_internal)
        .def("equals", &LogAffineTransform::equals,
             DS(LogAffineTransform, equals),
             "other"_a)
        .def("getBase", &LogAffineTransform::getBase, DS(LogAffineTransform, getBase))
        .def("setBase", &LogAffineTransform::setBase,
             DS(LogAffineTransform, setBase),
             "base"_a)
